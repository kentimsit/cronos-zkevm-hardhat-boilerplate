...
async function main() {
    ...
    console.log("\nChecking account balances for wallet address: ", l1Wallet.address, "...")
    ...
    const balanceL1TCRO_8decimals = await l2Wallet.getBalanceL1(TCRO_L1_ADDRESS);
    const balanceL1TCRO = ethers.formatUnits(balanceL1TCRO_8decimals * ethers.getBigInt("10000000000"), "ether");
    ...
    const txHash = "0x8760861e4e516543e2b754640d6660192fe969d1c149b5b72cc9b6335bcb0f31";
